...
Configurations that are used as a 'one-time' change and will be in affect during the installation process. Once the App is deployed, the changes to these App Settings  will not have any impact to your WordPress site. These application settings are shown for your reference only.
